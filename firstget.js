...
var i = 0;
var url = "http://sh.lianjia.com/ershoufang/d1"; 
//初始url 
    ...
    http.get(x, function (res) {     
     ...
     //监听end事件，如果整个网页内容的html都获取完毕，就执行回调函数
        res.on('end', function () {
         ...
         var child = $('div.info-panel a:first-child');

         var webaddr = "sh.lianjia.com" + child.attr('href');

         var atitle = child.attr('title');

         var xiaoquchild = $('div.info-panel a.laisuzhou:first-child ');

         var xiaoquaddr = "sh.lianjia.com" + xiaoquchild.attr('href');

         var xiaoquinfochild = $('div.info-panel span.nameEllipsis:first-child');

         var huxingchild = $('div.where a').first();
         ...
         //获取该房源的URL
            weblink: webaddr ,   
            //获取小区的URL
            xiaoqulink: xiaoquaddr,

            xiaoqutitle: xiaoqutitle,
