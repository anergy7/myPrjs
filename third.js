...
function startRequest(x) 
{
  ...
  socketPath :'/Applications/MAMP/tmp/mysql/mysql.sock'
         ...
         var huxinginfo = huxing.split('室');

         var room = huxinginfo[0];

         var ting = huxinginfo[1].replace('厅','')
...
id : i++
        ...
        //i是用来判断获取了多少篇文章
            ...
            connection.query('INSERT INTO lianjia SET ?',info_item,function (err, result) { 
                 if (err) { 
                    throw err; 
             }}); 
